...
class Const(Constants):
    ...
    SLACK_SUPPORT_WEBHOOK = "https://hooks.slack.com/services/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"
    ...
    POINT_AMOUNT_REFFERAL = 10
    POINT_AMOUNT_FLIP_STOREFRONT_WIN = 25
