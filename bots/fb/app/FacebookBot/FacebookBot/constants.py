...
class Const(Constants):
    ...
    ACCESS_TOKEN = "EAADzAMIzYPEBALV4ThFElJZB1lIXsNMsoeZCPb4I3BNgfTixOezzo2MIUduU6V0dN8hOLRNY0uY9taYtFOtWA4QT5q63H4ZAOUgAZBFZCI8qQfl5IRCY6GdFZBf1TZA3FSkw4FJI9spo0hb7pPSPZAxZA3b0TSzGvUg1iukEYHKIlmAZDZD"
    ...
    GIVEAWAY_TOKEN = "5c822aadf057f5653da4c06a089a6588"
    ...
    SLACK_PURCHASES_WEBHOOK = "https://hooks.slack.com/services/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"
    ...
    TOKENS_PER_DOLLAR = 0.39341
    FLIPS_PER_24_HOUR = 100
    GIVEAWAY_POINT_THRESHOLD = 0
    ...
    POINT_AMOUNT_REFFERAL_OWNER = 25000
    ...
    ENTRY_PRODUCT_REFERRAL = 'ENTRY_PRODUCT_REFERRAL'
    ENTRY_USER_REFERRAL = 'ENTRY_USER_REFERRAL'
    ENTRY_GIVEAWAY_REFERRAL = 'ENTRY_GIVEAWAY_REFERRAL'
    ENTRY_GAMEBOTS_REFERRAL = 'ENTRY_GAMEBOTS_REFERRAL'
    ENTRY_ICO_REFERRAL = 'ENTRY_ICO'
    ...
    PB_PAYLOAD_ICO = 'ICO'
    PB_PAYLOAD_DEPOSIT_SKINS = 'DEPOSIT_SKINS'
    PB_PAYLOAD_TRANSFER_POINTS = 'TRANSFER_SKINS'
    PB_PAYLOAD_LMON8_FAQ = 'LMON8_FAQ'
    PB_PAYLOAD_ICO_FAQ = 'ICO_FAQ'
    PB_PAYLOAD_CONVERT_YES = 'CONVERT_YES'
    PB_PAYLOAD_CONVERT_NO = 'CONVERT_NO'
    PB_PAYLOAD_HOW_ICO = 'HOW_ICO'
    ...
    RESERVED_TOKEN_REPLIES = "tokens"
    RESERVED_DEPOST_REPLIES = "deposit"
    RESERVED_ICO_REPLIES = "ico"
    RESERVED_MODERATOR_REPLIES = "mod"
    RESERVED_TASKS_REPLIES = "tasks"
    RESERVED_GIAVEAWAY_REPLIES = "ga|giveaway"
    RESERVED_FBPSID_REPLIES = "id|referral"
    RESERVED_LEADERBOARD_REPLIES = "leaderboard|leaders"
