...
class Const(Constants):
    ...
    PB_PAYLOAD_DM_STOREFRONT_OWNER = 'DM_STOREFRONT_OWNER'
    PB_PAYLOAD_DM_CUSTOMER = 'DM_CUSTOMER'
    PB_PAYLOAD_DM_CANCEL = 'DM_CANCEL'
    ...
    RESERVED_CUSTOMER_REPLIES = "menu"#main|main menu|menu"
